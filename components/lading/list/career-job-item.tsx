...
export default function CareerJobItem({ job }: Props) {
    const { slug, type, level, salary, location, urgent, createdAt, favorited, experience, company } = job;
        ...
        >
            ...
            <Stack sx={{ p: 3, pb: 0 }}>
                <Stack direction="row" alignItems="center" spacing={2.5}>
                    <Image alt={company.name} src={company.logo} sx={{ width: 48, height: 48, borderRadius: 1 }} />
