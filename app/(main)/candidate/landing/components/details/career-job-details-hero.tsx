...
export default function CareerJobDetailsHero({ job }: Props) {
    ...
    return (
        ...
        >
            <Container>
                <CustomBreadcrumbs
                    links={[{ name: 'Home', href: '/' }, { name: 'Jobs', href: paths.career.jobs }, { name: job.slug }]}
                    sx={{
                        mb: { xs: 5, md: 8 },
                        '& a': {
                            color: 'common.white',
                ...
                <Stack spacing={5} direction={{ xs: 'column', md: 'row' }} justifyContent={{ md: 'space-between' }}>
                    ...
                    <Stack spacing={2} direction="row" alignItems="flex-start" sx={{ width: 1, maxWidth: 340 }}>
