import { T_BackgroundType } from '../types';

export const varBgColor = (props?: T_BackgroundType) => {
...
export const varBgKenburns = (props?: T_BackgroundType) => {
    const duration = props?.duration || 5;
...
export const varBgPan = (props?: T_BackgroundType) => {
